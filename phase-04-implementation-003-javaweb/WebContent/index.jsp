...
<body >
	<img alt="" src="/static/imgs/pic008.jpg" class="background1">
	...
	<audio id="poem" src="/static/audio/wanderingEarch-poem.mp3"
		preload="auto"></audio>
    <span id="firstline" style="font-size: 22px; color: white"><span
		style="font-size: 38px; color: red"></span>
	</span>
	...
	<div id="poem-txt"
		...
		<br /> <span style="font-size: 18px; color: grey">
			</span><br /> <br />  <br /> 
	</div>
	...
	<div id="hornor" style="display:none;position:absolute;left:10x; bottom:10px;color:white;font-size:24px" align="center">2019年发生了很多大事，谨以此向<span style="color:red">千万为中华崛起牺牲和奋斗的</span><span style="color:orange">抗战烈士</span>表示最崇高的致敬 !  <br/> <br/> ！ <br/>！</div>
</body>
</html>